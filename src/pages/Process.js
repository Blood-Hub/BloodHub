...
// const imageTexts = [
//   "First Stage - lojpibqpicbiaspdbcn oxnc k'lmspdvndoiqhfnvbidjfknc`v'kl np]EOIFH",
//   "Second Stage",
//   "Text for Image 3",
//   "Text for Image 4",
//   "Text for Image 5",
...
//     <img src={img} alt="Slideshow" />
//     <img className="shadow" src={img} alt="" />
//     <p className="image-text">{imageText}</p> {/* Display the image text */}
//   </div>
// );
